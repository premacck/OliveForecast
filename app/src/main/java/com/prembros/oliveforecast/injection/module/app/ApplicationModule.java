...
public class ApplicationModule {
    ...
    private final OliveboardApplication application;

    public ApplicationModule(OliveboardApplication application) {
        this.application = application;
    }

    @Provides @AppScope OliveboardApplication provideApplication(){
        return application;
    }
}